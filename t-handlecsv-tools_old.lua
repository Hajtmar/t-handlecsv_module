...
function thirddata.handlecsv.csvreport(anyfilename) -- Listing report informations about opening a CSV file
	...
	infomakra=[[\crlf ]]
	for i = 1, thirddata.handlecsv.gNumCols[thirddata.handlecsv.getcurrentcsvfilename()] do 	-- for all fields in header
		local makroname=[[{\bf\backslash ]]..thirddata.handlecsv.tmn(thirddata.handlecsv.gColumnNames[thirddata.handlecsv.getcurrentcsvfilename()][i])..[[}]]
...
--  http://www.pragma-ade.nl/general/manuals/hybrid.pdf
 ...
 context.bTABLE(basespec)
 		 for i=1, thirddata.handlecsv.gNumRows[thirddata.handlecsv.getcurrentcsvfilename()] do
      	context.bTR()
		  for j=1,thirddata.handlecsv.gNumCols[thirddata.handlecsv.getcurrentcsvfilename()] do
  			context.bTD()
