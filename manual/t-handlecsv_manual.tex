...
\starttyping
\usemodule[handlecsv-test] % this command load module into my source code
\stoptyping
...
for i = 1, thirddata.handlecsv.gNumRows[thirddata.handlecsv.getcurrentcsvfilename()]-thirddata.handlecsv.gNumEmptyRows do
