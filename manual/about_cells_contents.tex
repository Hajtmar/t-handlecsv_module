...
% c \cA, c \cB, col \colA, col \colB, jmeno \colJmeno, \colJmeno[5] \crlf 

% numline: \colJmeno[\numline]  -- numline+1: \colJmeno[\thenumexpr{\numline+1}] \crlf



Syntax 1: previous:\previouscsvcell{4}: -- current:\currentcsvcell{4}: -- next:\nextcsvcell{4}:

Syntax 2: previous:\previouscsvcell{'D'}: -- current:\currentcsvcell{'D'}: -- next:\nextcsvcell{'D'}:

Syntax 3: previous:\previouscsvcell{'Jmeno'}: -- current:\currentcsvcell{'Jmeno'}: -- next:\nextcsvcell{'Jmeno'}:

Syntax 4: previous:\previouscsvcell{'cD'}: -- current:\currentcsvcell{'cD'}: -- next:\nextcsvcell{'cD'}:
