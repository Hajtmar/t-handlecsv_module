...
\def\doloopif#1#2#3#4{%
    ...
    \processaction[\paroperator][%
     <=>{\removeunwantedspaces% {number1}{<}{number2} ... Less
     \removeunwantedspaces\doloopfromto{1}{\numrows}{\ctxlua{if #1<#3 then context('\\blinehook\\fourthparam\\elinehook') else thirddata.handlecsv.addtonumline(-1) end}}%
     },% end < ... Less
     >=>{\removeunwantedspaces% {number1}{>}{number2} ... Greater
     \removeunwantedspaces\doloopfromto{1}{\numrows}{\ctxlua{if #1>#3 then context('\\blinehook\\fourthparam\\elinehook') else thirddata.handlecsv.addtonumline(-1) end}}%
     },% end > ... Greater
     ===>{\removeunwantedspaces% {number1}{==}{number2} ... Equal
     \removeunwantedspaces\doloopfromto{1}{\numrows}{\ctxlua{if #1==#3 then context('\\blinehook\\fourthparam\\elinehook') else thirddata.handlecsv.addtonumline(-1) end}}%
     },% end == ... Equal
     ~==>{\removeunwantedspaces% {number1}{~=}{number2} ... Not Equal
     \removeunwantedspaces\doloopfromto{1}{\numrows}{\ctxlua{if #1~=#3 then context('\\blinehook\\fourthparam\\elinehook') else thirddata.handlecsv.addtonumline(-1) end}}%
     },% end ~= ... Not Equal
     >==>{\removeunwantedspaces% {number1}{>=}{number2} ... GreaterOrEqual
     \removeunwantedspaces\doloopfromto{1}{\numrows}{\ctxlua{if #1>=#3 then context('\\blinehook\\fourthparam\\elinehook') else thirddata.handlecsv.addtonumline(-1) end}}%
     },% end >=  ... GreaterOrEqual
     <==>\removeunwantedspaces{% {number1}{<=}{number2} ... LessOrEqual
     \removeunwantedspaces\doloopfromto{1}{\numrows}{\ctxlua{if #1<=#3 then context('\\blinehook\\fourthparam\\elinehook') else thirddata.handlecsv.addtonumline(-1) end}}%
     },% end <= ... LessOrEqual
     eq=>{\removeunwantedspaces%  command {string1}{==}{string2} is converted to command command {string1}{eq}{string2} ... string1 is equal string2
	 \removeunwantedspaces\doloopfromto{1}{\numrows}{\doifelse{#1}{#3}{\blinehook\fourthparam\elinehook}{\addtonumline{-1}}}% 23.06.2017
	 %%%%%\doloopfromto{1}{\numrows}{\ctxlua{if '#1'=='#3' then context('\\blinehook\\fourthparam\\elinehook') else thirddata.handlecsv.addtonumline(-1) end}}%
     },%  end eq
     neq=>{\removeunwantedspaces%  command {string1}{~=}{string2} is converted to command command {string1}{neq}{string2} ... string1 is not equal string2
	 \removeunwantedspaces\doloopfromto{1}{\numrows}{\doifelse{#1}{#3}{\ctxlua{thirddata.handlecsv.addtonumline(-1)}}{\blinehook\fourthparam\elinehook}}% 23.06.2017
     %%%%%\doloopfromto{1}{\numrows}{\ctxlua{if '#1'~='#3' then context('\\blinehook\\fourthparam\\elinehook') else thirddata.handlecsv.addtonumline(-1) end}}%
     },% end neq
     in=>{\removeunwantedspaces% {substring}{in}{string} ... substring is contained inside string
     \removeunwantedspaces\doloopfromto{1}{\numrows}{\doifinstringelse{#1}{#3}{\blinehook\fourthparam\elinehook}{\addtonumline{-1}}}% \doifincsnameelse
     },% end in
     ~in=>{\removeunwantedspaces% {substring}{~in}{string} ... substring is not contained inside string
     \removeunwantedspaces\doloopfromto{1}{\numrows}{\doifinstringelse{#1}{#3}{\addtonumline{-1}}{\blinehook\fourthparam\elinehook}}% \doifincsnameelse
     },% end notin
     repeatuntil=>\removeunwantedspaces{% {substring}{until}{string} ... % Repeats the action until the condition is met. If it is not never met, will list all record
	 \removeunwantedspaces\doloop{\ctxlua{if '#1'=='#3' then context('\\exitloop') else context('\\ifEOF\\exitloop\\else\\blinehook\\fourthparam\\elinehook\\nextrow\\fi') end}}%
     },% end until % the comma , is very important here!!!
     whiledo=>\removeunwantedspaces{% {substring}{untilneq}{string} ... % Repeat action when the condition is met. When the condition is not met for the first line, the action will NOT BE performed!
	 \removeunwantedspaces\doloop{\ctxlua{if '#1'~='#3' then context('\\exitloop') else context('\\blinehook\\fourthparam\\elinehook\\ifEOF\\exitloop\\else\\nextrow\\fi') end}}%
