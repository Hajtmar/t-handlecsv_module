...
\unexpanded\def\tableactionexp{\expanded{\bTR\bTD\cA\eTD\bTD\Jmeno\eTD\bTD\Prijmeni\eTD\eTR}}
\unexpanded\def\tableaction{\expanded{\bTR\bTD\cA\eTD\bTD\Jmeno\eTD\bTD\Prijmeni\eTD\eTR}}
\unexpanded\def\tabaction{\expanded{\bTD\cA\eTD\bTD\Jmeno\eTD\bTD\Prijmeni\eTD}}
\unexpanded\def\XX{\expanded{\bTR\bTD XX exp \cA - \Jmeno\eTD\bTD\Jmeno\eTD\bTD\Prijmeni\eTD\eTR}}
\unexpanded\def\YY{\bTR\bTD YY noexp \cA - \Jmeno / \Prijmeni\eTD\bTD\Jmeno\eTD\bTD\Prijmeni\eTD\eTR}
\unexpanded\def\AA{\bTR\bTD\ AA \Jmeno\ \Prijmeni\eTD\bTD\Jmeno\eTD\bTD\Prijmeni\eTD\eTR}
\unexpanded\def\BB{\bTR\bTD\ BB \cA - \Jmeno \eTD\bTD\Jmeno\eTD\bTD\Prijmeni\eTD\eTR}
\unexpanded\def\CC{\bTR\bTD\ CC \Prijmeni\ \Jmeno / \Prijmeni\eTD\bTD\Jmeno\eTD\bTD\Prijmeni\eTD\eTR}
\unexpanded\def\DD{\bTR\bTD\ DD \cA - \Nick\eTD\bTD\Jmeno\eTD\bTD\Prijmeni\eTD\eTR}
...
\doloopaction % provádí pro všechny záznamy \lineaction


\def\lineaction{\tabaction}

\doloopaction{\tabaction}

\doloopaction{\lineaction}

\doloopaction{\tabaction}{4}

\doloopaction{\tabaction}{5}{7}
...
\doloopwhile{\Jmeno}{Tomáš}{\bTD Ahoj\eTD\bTD \Jmeno\ \Prijmeni\eTD}
...
ALE
\unexpanded\def\POKUS{\expanded{\bTD Nazdar\ \Id\ - \eTD\bTD \Jmeno\ \Prijmeni\eTD}}

\doloopuntil{\Id}{11}{\POKUS}
...
\doloopforall{\bTD\Jmeno\ Těpic\ \Id\ - \eTD\bTD \Jmeno\ \Prijmeni\eTD\bTD \Id\ \eTD}
...
Pokusy 9.7.2015
\def\CPrijmeni{\dosingleempty\doCPrijmeni}
\edef\doCPrijmeni[#1]{\iffirstargument\csvcell['E',#1]\else\columncontent['Prijmeni']\fi}

\def\CJmeno{\dosingleempty\doCJmeno}
\edef\doCJmeno[#1]{\iffirstargument\csvcell['D',#1]\else\columncontent['Jmeno']\fi}


\CJmeno\ \CPrijmeni


\CJmeno[6]\ \CPrijmeni[6]

U doloopfromto je třeba dávat \expanded{}!!!!!

\doloopfromto{2}{5}{\expanded{\bTD Ahoj\eTD\bTD \columncontent['Prijmeni'] \ \columncontent['Jmeno']\eTD}} %%% OK
\resetlinepointer
\doloopfromto{2}{5}{\bTD Ahoj\eTD\bTD \CJmeno -- \ \CPrijmeni\eTD} %%% OK


TEST 2
\def\lineaction{\bTD\cA\eTD\bTD\CJmeno\eTD\bTD\CPrijmeni\eTD}
