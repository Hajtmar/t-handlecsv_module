...
function thirddata.handlecsv.opencsvfile(filetoscan) -- Open CSV tabule, inicialize variables
	...
	if thirddata.handlecsv.isopenfile(inpcsvfile) then -- if file is open, then set needed pointers at first line of file only
	   thirddata.handlecsv.setpointersofopeningcsvfile(inpcsvfile)
		...
		-- thirddata.handlecsv.gTableRowsIndex['']={}
		-- thirddata.handlecsv.gTableRows['']={}
	...
	--	thirddata.handlecsv.gTableRows['']=thirddata.handlecsv.gTableRows[inpcsvfile] -- array of contents of cells of CSV table -> g_gTableRows[csvfilename][row][column]
	--  thirddata.handlecsv.gNumLine['']=thirddata.handlecsv.gNumLine[inpcsvfile] -- global variable -      g_gNumLine['csvfilename']=0
	--	thirddata.handlecsv.gNumRows['']=thirddata.handlecsv.gNumRows[inpcsvfile] -- global variable  - save number of rows of csv table: g_gNumRows['csvfilename']=0
	--  thirddata.handlecsv.gNumCols['']=thirddata.handlecsv.gNumCols[inpcsvfile] -- global variable  - save number of columns of csv table: g_gNumCols['csvfilename']=0
	--	thirddata.handlecsv.gCurrentLinePointer['']=thirddata.handlecsv.gCurrentLinePointer[inpcsvfile] -- ie. CSV line number ie. number of the currently processed row: g_gCurrentLinePointer['csvfilename']=0
	--  thirddata.handlecsv.gColumnNames['']=thirddata.handlecsv.gColumnNames[inpcsvfile] -- array with column names (readings from header of CSV file): g_gColumnNames['csvfilename']
	--  thirddata.handlecsv.gColNames['']=thirddata.handlecsv.gColNames[inpcsvfile] -- associative array with column names for indexing use f.e. g_gColNames['csvfilename']['Firstname']=1, etc...
	--	thirddata.handlecsv.gTableRowsIndex['']=thirddata.handlecsv.gTableRowsIndex[inpcsvfile] -- array of flags of lines of CSV table -> g_gTableEmptyRowsIndex['csvfilename'][i]= true or false
...
function thirddata.handlecsv.puvodnicreatexlscommand(xlsname)
local inpcsvfile=thirddata.handlecsv.getcurrentcsvfilename()
local cxlsname=tostring('col'..xlsname)
local docxlsname=tostring('docol'..xlsname)
local xlsname=tostring(''..xlsname)
	...
	context(thirddata.handlecsv.getcellcontent(xlsname,thirddata.handlecsv.gCurrentLinePointer[inpcsvfile]))
				 end
		    end
			})
		interfaces.definecommand(cxlsname, {
...
function thirddata.handlecsv.experimentalcreatexlscommand(xlsname)
local inpcsvfile=thirddata.handlecsv.getcurrentcsvfilename()
local cxlsname=tostring('c'..xlsname)
local docxlsname=tostring('doc'..xlsname)
local xlsname=tostring(''..xlsname)
		interfaces.definecommand (docxlsname, {
		    arguments = { { "option", "string" }  },
		    macro = function (opt_1)
...
--function thirddata.handlecsv.getlinepointerof(csvfile)
-- local csvfile=thirddata.handlecsv.handlecsvfile(csvfile)
